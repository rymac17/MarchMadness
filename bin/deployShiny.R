...
openxlsx::read.xlsx('C:/Users/ryanm/Dropbox/R/MarchMadness_data/teams/teams2026.xlsx', sheet='Sheet1') %>% 
  saveRDS(., 'data/teams2026.rds')


# necessary files
nf <- c('src/ncaaHelpers.R',
        'data/models/cv_outcome_2026.rds',
        'data/masterTBL.rds',
        'data/statsTBL.rds',
        'data/teams2026.rds',
        'app.R')
